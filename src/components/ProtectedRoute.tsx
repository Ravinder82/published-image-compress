...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#bdc3c7] via-white to-[#2c3e50]">
        <div className="flex flex-col items-center space-y-4">
          <div className="w-12 h-12 bg-gradient-to-r from-[#bdc3c7] to-[#2c3e50] rounded-xl animate-pulse"></div>
  ...
  if (!user) {
    return (
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#bdc3c7] via-[#ecf0f1] to-[#2c3e50]"></div>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-12 hover-lift">
            <div className="w-20 h-20 bg-gradient-to-r from-[#bdc3c7] to-[#2c3e50] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="flex flex-col items-center p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
                <div className="w-12 h-12 bg-gradient-to-r from-[#95a5a6] to-[#7f8c8d] rounded-xl flex items-center justify-center mb-3">
              ...
              <div className="flex flex-col items-center p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
                <div className="w-12 h-12 bg-gradient-to-r from-[#bdc3c7] to-[#2c3e50] rounded-xl flex items-center justify-center mb-3">
              ...
              <div className="flex flex-col items-center p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
                <div className="w-12 h-12 bg-gradient-to-r from-[#95a5a6] to-[#34495e] rounded-xl flex items-center justify-center mb-3">
            ...
            <Button 
              ...
              size="lg"
              className="bg-gradient-to-r from-[#bdc3c7] to-[#2c3e50] hover:from-[#95a5a6] hover:to-[#34495e] text-white px-10 py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
