    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-12 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">ImageCompress</span>
          ...
          <div>
            <h3 className="font-semibold mb-6 text-lg bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Product</h3>
          ...
          <div>
            <h3 className="font-semibold mb-6 text-lg bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">Support</h3>
            <ul className="space-y-3 text-gray-300">
